...
class _ExternalDatabase extends \IPS\Login\Handler
{
	...
	{		
		$return = array(
			...
			'sql_pass'		=>  new \IPS\Helpers\Form\Text( 'login_external_pass', isset( $this->settings['sql_pass'] ) ? $this->settings['sql_pass'] : NULL, TRUE ),
	...
	protected function _encryptedPassword( $providedPassword )
	{
		switch ( $this->settings['db_encryption'] )
		{
			...
			case 'password_hash':
				return password_hash( $providedPassword );
