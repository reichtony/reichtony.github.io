...
class _PermissionCache extends \IPS\Widget
{
	...
	public function __construct( $uniqueKey, array $configuration, $access=null, $orientation=null )
	{
		...
		if( !$this->cacheKey )
		{
			...
			$this->cacheKey = "widget_{$this->key}_" . $this->uniqueKey . '_' . md5( json_encode( $this->configuration ) . "_" . \IPS\Member::loggedIn()->language()->id . "_" . \IPS\Member::loggedIn()->skin . "_" . json_encode( $permissions ) . "_" . $this->orientation );
		}
	}
}