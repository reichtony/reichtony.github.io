...
abstract class _Query
{
	...
	public static function init( \IPS\Member $member = NULL )
	{
		...
		{
			return new \IPS\Content\Search\Elastic\Query( $member ?: \IPS\Member::loggedIn(), \IPS\Http\Url::external( \IPS\Settings::i()->search_elastic_server . '/' . \IPS\Settings::i()->search_elastic_index ) );
		}
		else
		{
