...
class _guestSignUp extends \IPS\Widget
{
	...
	public function configuration( &$form=null )
	{
		...
		$form->add( new \IPS\Helpers\Form\Translatable( 'block_guestsignup_message', NULL, TRUE, array(
			'app'			=> 'core',
			'key'			=> 'widget_guestsignup_text',
			'editor'		=> array(
				'app'			=> 'core',
				'key'			=> 'Widget',
				'autoSaveKey' 	=> 'widget-' . $this->uniqueKey,
				'attachIds'	 	=> isset( $this->configuration['content'] ) ? array( 0, 0, 'widget_guestsignup_text' ) : NULL
			),
		) ) );
		return $form;
 	}
	...
	public function delete()
	{
 	...
 	public function preConfig( $values )
 	{
		...
		\IPS\Lang::saveCustom( 'core', 'widget_guestsignup_text', $values[ 'block_guestsignup_message' ] );
	...
	public function render()
	{
		...
		else
		{
			...
			return $this->output( $login, $title, $text );
		}
	}
}