...
class _newsletter extends \IPS\Widget
{
	...
	public function configuration( &$form=null )
	{
		...
		$form->add( new \IPS\Helpers\Form\Translatable( 'block_newsletter_signup_text', NULL, TRUE, array(
			'app'			=> 'core',
			'key'			=> 'block_newsletter_signup',
			'editor'		=> array(
				'app'			=> 'core',
				'key'			=> 'Widget',
				'autoSaveKey' 	=> 'widget-' . $this->uniqueKey,
				'attachIds'	 	=> isset( $this->configuration['content'] ) ? array( 0, 0, 'block_newsletter_signup' ) : NULL
			),
		) ) );
		return $form;
	}
	...
	{
		\IPS\Lang::deleteCustom(  'core', 'block_newsletter_signup' );
