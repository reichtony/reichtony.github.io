...
{	
	...
	protected function settings()
	{
		...
		$form->add( new \IPS\Helpers\Form\Number( 'stats_keywords_prune', \IPS\Settings::i()->stats_keywords_prune, FALSE, array( 'unlimited' => 0, 'unlimitedLang' => 'never' ), NULL, \IPS\Member::loggedIn()->language()->addToStack('after'), \IPS\Member::loggedIn()->language()->addToStack('days') ) );
	
		if ( $values = $form->values() )
		{
			$values['stats_keywords'] = json_encode( $values['stats_keywords'] );
