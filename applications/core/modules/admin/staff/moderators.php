...
class _moderators extends \IPS\Dispatcher\Controller
{
	...
	protected function edit()
	{
		...
		\IPS\Output::i()->output 	.= $form->customTemplate( array( call_user_func_array( array( \IPS\Theme::i(), 'getTemplate' ), array( 'members' ) ), 'moderatorPermissions' ) );
	}
	...
	protected function actionLogs()
	{
		...
		/* Search */
		$table->quickSearch = array( array( 'note', 'word_custom', 'word_default' ), 'action' );
