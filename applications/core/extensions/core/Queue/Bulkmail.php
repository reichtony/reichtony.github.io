...
class _Bulkmail
{
	...
	public function run( $data, $offset )
	{
		try
		{
			...
			/* Send it */
			$email = \IPS\Email::buildFromContent( $mail->subject, \IPS\Email::staticParseTextForEmail( $content, \IPS\Lang::load( \IPS\Lang::defaultLanguage() ) ), NULL, \IPS\Email::TYPE_BULK )
