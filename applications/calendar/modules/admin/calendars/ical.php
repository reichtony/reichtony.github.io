	...
	public function upload()
	{
		...
		if ( $values = $form->values() )
		{
			...
			try
			{
				...
				$count	= $icsParser->parse( \file_get_contents( $values['feed_file'] ), $values['feed_calendar_id'], $values['feed_member_id'], ( isset( $values['feed_venue_id'] ) ) ? $values['feed_venue_id'] : NULL );
			}
