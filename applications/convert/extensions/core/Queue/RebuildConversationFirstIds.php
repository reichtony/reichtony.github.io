...
class _RebuildConversationFirstIds
{
	...
	public function run( $data, $offset )
	{
		...
		foreach( new \IPS\Patterns\ActiveRecordIterator( \IPS\Db::i()->select( '*', 'core_message_topics', array( "mt_id>?", $offset ), "mt_id ASC", array( 0, 50 ) ), 'IPS\core\Messenger\Conversation' ) AS $conversation )
		{
			try
			{
				/* Set first post */
