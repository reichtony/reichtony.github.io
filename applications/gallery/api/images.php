...
class _images extends \IPS\Content\Api\ItemController
{
	 ...
	 * Upload an image
	 *
	 * @note	For requests using an OAuth Access Token for a particular member, any parameters the user doesn't have permission to use are ignored (for example, locked will only be honoured if the authentictaed user has permission to lock images).
